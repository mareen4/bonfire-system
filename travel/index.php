	  ...
	  <h3>About Us</h3>
	   ...
	   <div class="container">		  
		 <div class="col-md-4 about-grids">
			 <h4>Our Vision</h4>
			 <p>As technology is growing rapidly we are also moving to a technical World where everything we want is online. </p>
		 </div>
		 ...
		 <div class="col-md-4 about-grids">
			 ...
			 <p>To generate how the system will provide reports that can be used for decision making.</p>
		 </div>
	 </div>
</div>
<!--/About-->
